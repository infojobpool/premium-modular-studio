...
export const CITY_PAGE_COPY: Record<StudioLocationId, CityPageCopy> = {
  hyderabad: {
    ...
    leadershipSpotlight: {
      ...
      roleLine: "Founder & CEO · Vivid In2terio",
  ...
  bhubaneswar: {
    ...
    leadershipSpotlight: {
      ...
      sectionAriaLabel: "Partner spotlight",
      name: "Gargi Panda",
      roleLine: "Partner · Vivid In2terio",
      ...
      imageAlt: "Gargi Panda, Partner — Vivid In2terio Bhubaneswar",
      highlights: [
        {
      ...
      compactCtaLabel: "Read partner story",
    },
    trustHighlights: [
      {
