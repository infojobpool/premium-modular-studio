          ...
          <div className="relative z-10 grid gap-8 px-7 py-10 sm:px-10 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-10">
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-full bg-accent px-6 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-ink"
              >
                Book product consult
              </Link>
              <Link
                href={`/${location.id}/projects`}
                className="inline-flex items-center justify-center rounded-full border border-canvas/40 px-6 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-canvas"
              >
